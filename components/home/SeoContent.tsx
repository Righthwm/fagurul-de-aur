...
export const homeFaqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Livrăm prin curier rapid în toată România, de regulă în 24–48 de ore lucrătoare. Costul transportului este 30 lei pentru livrarea la oraș și 50 lei pentru livrarea la sat, plus 2 lei pentru fiecare borcan de miere din comandă, afișat la finalizarea comenzii. Poți comanda miere naturală online cu plata cu cardul sau ramburs la livrare.",
  },
];
